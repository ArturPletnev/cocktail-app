...
const cocktailsDB = {
    ...
    'алкогольные_сладкие': [
        ...
        { name: 'ФИЕРО ТОНИК', ingredients: 'мартини фиеро, тоник', price: '250 руб.', emoji: '🍊' },
        { name: 'БЕЛЛИНИ', ingredients: 'персик, игристое, сироп', price: '250 руб.', emoji: '🍑' }
    ],
    ...
    'алкогольные_кисло-сладкие': [
        ...
        { name: 'STRAWBERRY MARGARITA', ingredients: 'текила, апельсиновый ликер, сок лимона, клубника, сироп', price: '350 руб.', emoji: '🍓' }
    ],
    ...
    // ЛИМОНАДЫ
    'лимонады': [
        { name: 'Лимонады в лимонадниках', ingredients: '5 литров: гранатовый, маракуевый, апельсиновый', price: '2500 руб.', emoji: '🧪'}
    ]
};
