...
const cocktailsDB = {
    ...
    'алкогольные_сладкие': [
        ...
        { name: '🏖️ СЕКС НА ПЛЯЖЕ', ingredients: 'водка, сироп гренадин, сироп маракуя, лимонный сок, сок апельсин', price: '250 руб.', emoji: '🏖️' },
    ...
    'алкогольные_шоты': [
        ...
        { name: '❤️ Гранатовый', ingredients: 'водка, гренадин, сок лимона', price: '150 руб.', emoji: '❤️' },
    ...
    'лимонады': [
        ...
        { name: '❤️ Лимонад "Гранатовый"', ingredients: 'сок граната, лимон, мята, сахарный сироп', price: '250 руб./литр', emoji: '❤️' },
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Тестовая кнопка (можно удалить после теста)
    const testBtn = document.createElement('button');
    testBtn.textContent = 'Тест JS';
    testBtn.style.cssText = 'position:fixed;top:10px;right:10px;z-index:1000;padding:10px;background:#ff6b6b;color:white;border:none;border-radius:5px;';
    testBtn.onclick = () => alert('JS работает!');
